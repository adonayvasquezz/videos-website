...
export const home_videos: IHomeVideos[] = [
  {
    id: "1",
    title:
      "Cámara aprueba por mayoría la ley que bloquearía uso de TikTok en EE. UU.",
    video_image:
  ...
  },
  {
    id: "2",
    title:
      "Los votantes latinos podrían ser la clave de las presidenciales en EE.UU.",
    video_image:
  ...
  {
    id: "3",
    title: "Claude 3 vs ChatGPT: ¿Quién lidera la IA? Mi veredicto",
    video_image:
